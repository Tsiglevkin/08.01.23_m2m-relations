...
### Примечание
Перед стартом требуется создать свою БД, внеся свои данные в Settings.py.
Исправлена проблема по проверке уникальности главного тэга (articles.admin.py).
Теги на главной странице отображаются, некорректно стоит главный тег.
